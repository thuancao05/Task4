...
public class printBarcodes_function extends basePage {
    ...
    public printBarcodes_function(WebDriver driver) {
        super(driver);
    }
    ...
    public void selectStyle(String style){
        ...
        // chon style
        WebElement cbStyleTxtBox = getWait().until(ExpectedConditions.visibilityOfElementLocated(printBarcodesPage.cbStyle));
    ...
    public boolean isChecked(By by){
        String check = "";
        check = commonFunction.getAttribute("class", getWait().until(ExpectedConditions.visibilityOfElementLocated(by)));
