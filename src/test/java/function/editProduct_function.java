...
public class editProduct_function extends basePage {
    ...
    public editProduct_function(WebDriver driver) {
        super(driver);
    }
    ...
    public void selectProductType(String type){   //nut select nay bi an, nen phai xoa attribute style = "display:none" truoc khi thao tac
        ...
        // chon stype
        WebElement cbTypeTxtBox = getWait().until(ExpectedConditions.visibilityOfElementLocated(editProductPage.cbProductType));
    ...
    public void selectBarcode(String code){  //nut select nay bi an, nen phai xoa attribute style = "display:none" truoc khi thao tac
        ...
        // chon barcode
        WebElement cbTypeTxtBox = getWait().until(ExpectedConditions.visibilityOfElementLocated(editProductPage.cbBarcode));
        Select selectType = new Select(cbTypeTxtBox);
...
//    //ham chon Tax method
    public void selectTaxMethod(String method){  //nut select nay bi an, nen phai xoa attribute style = "display:none" truoc khi thao tac
        ...
        // chon barcode
        WebElement cbTypeTxtBox = getWait().until(ExpectedConditions.visibilityOfElementLocated(editProductPage.cbTaxMethod));
        Select selectType = new Select(cbTypeTxtBox);
        String i = "0";
