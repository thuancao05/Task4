...
public class listPurchases_function extends basePage {
    ...
    public listPurchases_function(WebDriver driver) {
        super(driver);
    }
    ...
    public void checkDateFormat()  {
        ...
        for (int i = 1; i<= rowTotal; i++){
            WebElement element = getDriver().findElement(By.xpath("//table[@id='POData']/tbody/tr[" + i + "]/td[" + column + "]"));
